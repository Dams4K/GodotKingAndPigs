...
func _physics_process(delta: float) -> void:
	...
	animation_tree["parameters/conditions/is_idle"] = not is_moving and not is_jumping and not is_falling and not is_attacking
	animation_tree["parameters/conditions/is_moving"] = is_moving and not is_jumping and not is_falling and not is_attacking
	animation_tree["parameters/conditions/is_attacking"] = is_attacking
	animation_tree["parameters/conditions/is_jumping"] = is_jumping and not is_attacking
	animation_tree["parameters/conditions/is_falling"] = is_falling and not is_attacking
